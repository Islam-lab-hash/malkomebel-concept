const SOCIALS = [
  ['WA', 'WhatsApp', 'whatsapp://send/?phone=79185106999'],
  ['MAX', 'Max', 'https://max.ru/u/f9LHodD0cOLWEHnLTOSeadpYo25q7dHiAATFOq5tytlpwu6WdYVpgsUxs3g'],
  ['TG', 'Telegram', 'https://t.me/malkomeb'],
  ['VK', 'VK', 'https://vk.com/malkomebel'],
];
...
const socials = () => SOCIALS.map(([short, label, url]) => `<a class="social-link" href="${url}" target="_blank" rel="noreferrer" aria-label="${label}"><b>${short}</b><span>${label}</span></a>`).join('');
